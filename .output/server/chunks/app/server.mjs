import { hasInjectionContext, getCurrentInstance, version, unref, inject, toRef, isRef, defineAsyncComponent, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, shallowRef, shallowReactive, isReadonly, isShallow, isReactive, toRaw, computed, withCtx, mergeProps, nextTick, defineComponent, ref, h, Suspense, Transition } from 'vue';
import { f as useRuntimeConfig$1, m as withQuery, n as hasProtocol, p as parseURL, o as isScriptProtocol, j as joinURL, i as createError$1, $ as $fetch$1, q as sanitizeStatusCode, r as createHooks, t as withoutTrailingSlash, v as defu, x as parse, y as getRequestHeader, z as destr, A as isEqual, B as setCookie, C as getCookie, D as deleteCookie } from '../nitro/node-server.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-900d0046.mjs').then((m) => m.default || m)
  }
];
...
const LazyIcon = defineAsyncComponent(() => import('./_nuxt/Icon-4438c5ee.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./_nuxt/IconCSS-b202154e.mjs').then((r) => r.default));
...
const useDirectusToken = () => {
  ...
  const config = (/* @__PURE__ */ useRuntimeConfig()).public;
...
const useDirectus = () => {
  ...
  return async (url, fetchOptions = {}, useStaticToken = true) => {
    ...
    try {
      ...
      {
        console.error(
          "[Directus Error]: " + ((_a = err.response) == null ? void 0 : _a.status) + ", " + ((_b = err.response) == null ? void 0 : _b.statusText)
        );
      }
      throw createError({
        statusCode: (_c = err.response) == null ? void 0 : _c.status,
        statusMessage: (_d = err.response) == null ? void 0 : _d.statusText,
        data: (_e = err.response) == null ? void 0 : _e._data
      });
    }
  };
};
const useDirectusAuth = () => {
  ...
  const fetchUser = async (useStaticToken) => {
    ...
    if (token.value) {
      try {
        if ((_a = config.public.directus.fetchUserParams) == null ? void 0 : _a.filter) {
...
const plugin_1doCGnr5OF = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  ...
  [__temp, __restore] = executeAsync(() => checkAutoRefresh()), await __temp, __restore();
  [__temp, __restore] = executeAsync(() => checkIfUserExists()), await __temp, __restore();
...
const layouts = {
  default: () => import('./_nuxt/default-58acbe3a.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-22c357df.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-9fb9247b.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-3ca43631.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
...
export { _export_sfc as _, useState as a, useNuxtApp as b, createError as c, entry$1 as default, injectHead as i, navigateTo as n, resolveUnrefHeadInput as r, useRouter as u };
